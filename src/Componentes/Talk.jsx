...
const Talk = () => {
  const [mostrandos, SetMostrandos] = useState('Oculto')
    const Upper = () => {
      if (document.documentElement.scrollTop > document.documentElement.scrollHeight/4*3-3 && document.documentElement.scrollTop < document.documentElement.scrollHeight ) {
    ...
    return (
      <div className="Talk">
        ...
        <div className={`Contactos  ${mostrandos}`}>
          <div className="Whatssap" onClick={() => {window.open('https://wa.me/50257175378')}}></div>
